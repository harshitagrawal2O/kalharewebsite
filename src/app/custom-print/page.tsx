...
export default function CustomPrint() {
  ...
  const colors = [
    ...
    { id: "gray", name: "Gray", hex: "#6B7280" },
    {
      id: "multicolor",
      name: "Multicolor",
      hex: "linear-gradient(135deg, #EF4444 0%, #F59E0B 25%, #10B981 50%, #3B82F6 75%, #A855F7 100%)",
    },
  ];
  ...
  const finishes = [
    {
      id: "standard",
      name: "Standard",
      description: "Layer lines visible",
      price: 0,
    },
    {
      id: "smooth",
      name: "Smooth",
      description: "Sanded & polished",
      price: 50,
    },
    {
      id: "painted",
      name: "Painted",
      description: "Professional paint job",
      price: 100,
    },
  ];
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!permissionChecked) {
      alert(
        "Please allow read/write permission for uploaded files by checking the box below.",
      );
      return;
    }
  ...
  const calculateEstimate = () => {
    ...
    const totalFileSizeInMB = uploadedFiles.reduce(
          ...
          >
                  ...
                  <>
                    ...
                    >
                      ...
                      <p className="text-lg font-semibold text-foreground mb-2">
                        {uploading
                          ? "Uploading..."
                          : "Click to upload 3D files"}
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Supports: STL, OBJ, 3MF, STEP, STP (No size
                        restrictions)
                      </p>
                    </div>
                    ...
                    <div className="mt-4 flex items-start gap-2">
                      ...
                      />
                      <label
                        htmlFor="drive-permission"
                        className="text-sm text-muted-foreground"
                      >
                        I give permission to read and write files on my Google
                        Drive for uploading and sharing this file.
                      </label>
                    </div>
                  </>
                )}
                ...
                {uploadedFiles.length > 0 && (
                  <div className="space-y-2">
                    {uploadedFiles.map((file, index) => (
                      <div
                        key={index}
                        className="border-2 border-primary/50 rounded-lg p-4 bg-primary/5"
                      >
            ...
            <Card>
              ...
              <CardContent>
                ...
                <AnimatePresence>
                  {expandedMaterial &&
                    materials.find((m) => m.id === expandedMaterial) && (
                  ...
                  <div className="flex items-start gap-2 p-3 bg-primary/5 border border-primary/20 rounded-lg mb-4">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-muted-foreground">
                        Send your requirements via WhatsApp and we&apos;ll
                        provide an accurate quote with delivery timeline.
                      </p>
                    </div>
                  </div>
