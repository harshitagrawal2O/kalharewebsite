          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit shrink-0 text-sm text-muted-foreground bg-secondary shadow-input"
                    >
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute opacity-0 border border-dashed border-cta inset-0 z-30 bg-transparent flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md"
              ></motion.div>
            )}
          </div>
        </div>
...
export function GridPattern() {
  ...
  const rows = 11;
  return (
    <div className="flex bg-secondary shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px scale-105">
